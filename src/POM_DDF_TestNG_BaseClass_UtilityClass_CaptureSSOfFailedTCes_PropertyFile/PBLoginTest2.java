...
public class PBLoginTest2 extends BaseClass2
{
	...
	public void signInToApp() throws IOException, InterruptedException
	{
		...
		mobnum.inpPBMobNumPage2mobNum(UtilityClass2.getPFData("MobNum"));
		mobnum.clickSignInWithPwdBtn();
		pwd.inpPBPwdPage2pwd(UtilityClass2.getPFData("Pwd"));
	...
	@AfterMethod
	public void logOutFromBrowser(ITestResult s1) throws IOException
	{
		if(s1.getStatus()==ITestResult.FAILURE)
		{
			UtilityClass2.captureSS(driver, TCID);
		}
	}
